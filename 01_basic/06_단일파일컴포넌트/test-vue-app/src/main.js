...
import { createApp } from 'vue'; // Vue에서 앱을 만들수 있는 함수 가져오기
// import App from './App.vue';     // 기본 컴포넌트 사용
// import App from './App2.vue'; //App2.vue 사용  객체를 이용한 props 전달
// import App from './App3.vue';   //props 유효성검사
// import App from './App4.vue';   // 사용자 정의 이벤트(자식 -> 부모 이벤트 발신)
import App from './App4-2.vue'; // 이벤트 유효성 검증

// 전역 컴포넌트 등록
// import CheckboxItem2 from './components/CheckboxItem.vue';
// createApp(App).component('CheckboxItem1', CheckboxItem2).mount('#app');

createApp(App).mount('#app');
// App.vue를 기반으로 Vue 앱을 만들어서
// index.html에 있는 #app인 요소에 붙이기(마운트)
//------------------------------------------------------------------------------
